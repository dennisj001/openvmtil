...
int8 _CalculateModRmByte(int64 mod, int64 reg, int64 rm, int64 disp, int64 sib, int64 operandSize);
void _Compile_Displacement(int64 disp);
void Compile_Displacement(int64 modRm, int64 disp);
...
void _Compile_LEA(int64 reg, int64 rm, int64 sib, int64 disp, int64 size);
...
void _Compile_Move_Reg_To_Reg(int64 dstReg, int64 srcReg, int64 size);
...
void _Compile_Move(int64 direction, int64 reg, int64 rm, int64 sib, int64 disp, int64 operandSize);
void _Compile_Move_Reg_To_Rm(int64 dstRmReg, int64 srcReg, int64 disp, int64 operandSize);
void _Compile_Move_AddressValue_To_EAX(int64 address);
void _Compile_Move_EAX_To_MemoryAddress(int64 address);
void _Compile_Move_Rm_To_Reg(int64 dstReg, int64 srcRmReg, int64 disp, int64 operandSize);
...
void _Compile_Call(int32 callOffset);
...
void Compile_X_Group5(Compiler *compiler, int64 op, int64 size);
void _Compile_optInfo_X_Group1(Compiler *compiler, int64 op);
void Compile_X_Group1(Compiler *compiler, int64 op, int64 ttt, int64 n, int64 size);
void _Compile_Jcc(int64 bindex, int64 overwriteFlag, int64 nz, int64 ttt);
void _Compile_CallTos(void);
...
void _Compile_SetAtAddress_WithReg(int64 *address, int64 reg, int64 thruReg, int64 size);
void _Compile_Move_Literal_Immediate_To_Reg(int64 reg, int64 value, int64 size);
void _Compile_LocalOrStackVar_RValue_To_Reg(Word *word, int64 reg, int64 size);
void Do_ObjectOffset(Word *word, int64 reg);
void _Compile_GetVarLitObj_RValue_To_Reg(Word *word, int64 reg, int64 size);
void _Compile_SetVarLitObj_With_Reg(Word *word, int64 reg, int64 thruReg, int64 size);
void _Compile_GetVarLitObj_LValue_To_Reg(Word *word, int64 reg, int64 size);
...
void Compile_Store(Compiler *compiler, int64 stackReg, int64 size);
void Compile_Poke(Compiler *compiler, int64 stackReg, int64 size);
void Compile_AtEqual(int64 stackReg, int64 size);
...
void Compile_Minus(Compiler *compiler, int64 size);
void Compile_Plus(Compiler *compiler, int64 size);
void Compile_IMultiply(Compiler *compiler, int64 size);
void _Compile_Divide(Compiler *compiler, uint64 type, int64 size);
void Compile_Divide(Compiler *compiler);
void Compile_Mod(Compiler *compiler);
void Compile_Group1_X_OpEqual(Compiler *compiler, int64 op, int64 size);
...
void _Compile_Move_StackN_To_Reg(int64 reg, int64 stackReg, int64 index, int64 size);
void _Compile_Move_Reg_To_StackN(int64 stackReg, int64 index, int64 reg, int64 size);
void _Compile_Move_StackNRm_To_Reg(int64 reg, int64 stackReg, int64 index, int64 size);
void _Compile_Move_Reg_To_StackNRm_UsingReg(int64 stackReg, int64 index, int64 reg, int64 ureg, int64 size);
void _Compile_Stack_PushReg(int64 stackReg, int64 reg, int64 size);
void _Compile_Stack_PopToReg(int64 stackReg, int64 reg, int64 size);
void Compile_Stack_PushEAX(int64 stackReg, int64 size);
void Compile_Move_TOS_To_EAX(int64 stackReg, int64 size);
void Compile_Move_EAX_To_TOS(int64 stackReg, int64 size);
void Compile_Pop_To_EAX(int64 stackReg, int64 size);
void Compile_Pop_ToEAX_AndCall(int64 stackReg, int64 size);
...
void Compile_Cmp_Set_tttn_Logic(Compiler *compiler, int64 ttt, int64 negateFlag, int64 size);
...
void Compile_LogicalAnd(Compiler *compiler, int64 size);
void Compile_LogicalNot(Compiler *compiler);
void _Compile_LogicalNot(Compiler *compiler, int64 size);
void Compile_Equals(Compiler *compiler, int64 size);
void Compile_DoesNotEqual(Compiler *compiler, int64 size);
void Compile_LessThan(Compiler *compiler, int64 size);
void Compile_GreaterThan(Compiler *compiler, int64 size);
void Compile_LessThanOrEqual(Compiler *compiler, int64 size);
void Compile_GreaterThanOrEqual(Compiler *compiler, int64 size);
void Compile_Logical_X(Compiler *compiler, int64 op, int64 size);
