...
void CfrTil_Debugger_Registers(void);
...
void Debugger_Compile_Restore_Runtime_DebuggerCpuState(Debugger *debugger, int32 setupOff);
void Debugger_Compile_Save_RunTime_DebuggerCpuState(Debugger *debugger);
void CfrTil_Compile_SaveCompileTimeDebuggerCpuState(CfrTil *cfrtil);
void CfrTil_Compile_RestoreCompileTimeDebuggerCpuState(CfrTil *cfrtil);
...
void Debug_ExtraShow(int32 size);
/* basis/core/string.c */
...
void Debugger_CpuState_Show(void);
void _Debugger_Registers(Debugger *debugger);
...
void _Compile_Debug_GetESP(int *where);
...
void CfrTil_Debugger_ShowCpuState(void);
/* primitives/memory.c */
