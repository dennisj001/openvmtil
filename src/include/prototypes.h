...
Word *_CfrTil_LocalWord(byte *name, int64 ctype);
Word *CfrTil_LocalWord(byte *name, int32 index, int64 ctype);
...
void _Tick(Context *cntx, int32 findWordFlag);
...
void _CfrTil_SingleQuote(int32 findWordFlag);
