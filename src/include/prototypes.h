...
void _Compile_CpuState_Restore(CpuState *cpu, int32 restoreEspEbpFlag);
void Compile_CpuState_Restore(CpuState *cpu);
CpuState *_CpuState_Copy(CpuState *dst, CpuState *src);
CpuState *CpuState_Copy(CpuState *cpu0, uint32 type);
CpuState *CpuState_New(uint32 type);
CpuState *_CpuState_Save(void);
void _CpuState_Restore(CpuState *cpu);
...
void ReadLine_Init(ReadLiner *rl, ReadLiner_KeyFunction ipf, uint32 type);
...
void CpuState_SyncStackPointersFromCpuState(CpuState *cpus);
...
void Debugger_AdjustEdi(Debugger *debugger);
