...
void _Compile_GetVarLitObj_RValue_To_Reg(Word *word, int32 reg, int32 index);
...
void _PrintNStackWindow(int32 *reg, byte *name, byte *regName, int32 size);
...
void _CfrTil_SetStackPointerFromDebuggerCpuState(CfrTil *cfrTil);
...
int32 _OpenVmTil_Pause(void);
void OpenVmTil_Pause(byte *msg);
...
/* basis/debug.c */
byte *GetStateString(Debugger *debugger);
