...
void _Compile_Sync_EsiToDsp(int32 thruReg);
void _Compile_Sync_DspToEsi(void);
...
Word *_CfrTil_LocalWord(byte *name, int32 index, int64 ctype);
...
Namespace *_CfrTil_Parse_LocalsAndStackVariables(int32 svf, int32 lispMode, ListObject *args, Stack *nsStack, Namespace *localsNs);
...
void _ReadLine_MoveInputStartToLineStart(int32 fromPosition, int32 lineUpFlag);
