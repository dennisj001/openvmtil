...
char *_String_HighlightTokenInputLine(byte *buffer, byte *token, int32 tokenStart, int32 inc, int32 flag);
...
void _Debugger_SetStackPointerFromDebuggerCpuState(Debugger *debugger);
...
int32 String_FindStrnCmpIndex(byte *sc, byte *name0, int32 index0, int32 wl0, int32 inc);
...
int32 CheckForString(byte *address);
