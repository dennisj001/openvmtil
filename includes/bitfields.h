...
#define ADD_MEM_CHUNK_HEADER ( (uint) 1 << 0 ) 
#define ADD_TO_LIST ( (uint) 1 << 1 ) 
#define INIT_HEADER ( (uint) 1 << 2 ) 
#define RETURN_CHUNK_HEADER ( (uint) 1 << 3 ) 
#define MEM_CHUNK_ACCOUNT ( (uint) 1 << 4 ) 
#define RETURN_CHUNK_DATA ( (uint) 1 << 5 ) 
#define ADD_TO_PERMANENT_MEMORY_LIST ( (uint) 1 << 6 ) 
