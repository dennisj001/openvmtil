...
void _Compile_LocalOrStackVar_RValue_To_Reg(Word *word, int32 reg, int32 initFlag);
...
void _Compile_GetAddress_ToReg(int32 address, int32 reg);
...
void _PrintNReturnStack(int32 *esp, int32 size);
