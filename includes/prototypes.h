...
ListObject *_LO_MacroPreprocess(ListObject **pl0);
...
ListObject *_LO_DefMacro(ListObject *l0, ListObject *locals);
...
void _LO_ReadEvalPrint_ListObject(ListObject *l0, int32 parenLevel, int32 continueFlag);
