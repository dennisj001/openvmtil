...
int32 _dllist_Get_N_Node_M_Slot_Value(dllist *list, int32 n, int32 m);
void _dllist_Set_N_Node_M_Slot_With_Value(dllist *list, int32 n, int32 m, int32 value);
