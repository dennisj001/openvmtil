...
void _Compile_X_Group1(Compiler *compiler, int32 op);
...
Word *_Lexer_LiteralObject_New(Lexer *lexer, uint32 uliteral);
...
byte *_Lexer_ParseNextToken_WithDelimiters(Lexer *lexer, byte *delimiters, int32 checkListFlag, int32 state);
...
void Lexer_AllowDot(Lexer *lexer);
void Lexer_AllowDot_Off(Lexer *lexer);
...
Symbol *_Word_Find_Symbol(DLList *list, int32 state, byte *name);
