...
void _CfrTil_AppendCharToSourceCode(CfrTil *cfrtil, byte c, int32 convertToSpaceFlag);
...
node *DWL_Find(Word *word, byte *address, byte *name, int32 showAll, int32 fromFirst);
...
byte *_String_AppendConvertCharToBackSlashAtIndex(byte *dst, byte c, int32 *index);
