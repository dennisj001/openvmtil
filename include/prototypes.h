...
void _DObject_ValueDefinition_Init(Word *word, uint32 value, uint64 ctype, uint64 funcType, byte *function, int arg);
...
void _PrintNStack(int32 *reg, byte *name, byte *regName, int32 size);
...
void Debugger_PrintReturnStack(Debugger *debugger);
void CfrTil_Debugger_PrintReturnStack(void);
void _Debugger_ReturnStack(Debugger *debugger);
void Debugger_ReturnStack(void);
...
void _Interpret_Preprocessor(int32 ifFlag);
...
void Debugger_SetupStack(Debugger *debugger, int32 size);
...
ListObject *_LO_Define0(byte *sname, ListObject *idNode, ListObject *locals);
